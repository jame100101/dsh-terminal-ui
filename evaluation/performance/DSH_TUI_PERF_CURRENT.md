...
Recorded UTC: 2026-08-31T08:12:28.531Z
Source: local working tree based on HEAD `30ec83a497e1`; TUI package `0.1.0-rc.13`.
...
|---|---:|---:|---:|---:|
| 100 | 223 | 400 | 1490322 | 20.6 |
| 500 | 223 | 512 | 1493061 | 16.6 |
...
|---|---:|---:|---|
| Fold heap, 100 turns | 17.5 MB | 20.6 MB | same range; no forced GC in either run |
| Fold heap, 500 turns | 19.0 MB | 16.6 MB | same range; no forced GC in either run |
| `dsh-tui --version` | 90–92 ms | 173 ms median | lower in this sample |
| built `--help` | about 100 ms | 203 ms median | same range |
| warm `--dump-config` | 300–600 ms | 400 ms median | inside the historical range |
...
|---|---:|---:|---:|
| `apps/tui-cli/bin/dsh-tui.js --version` | 173 | 196 | 0 |
| `apps/cli/lib/bin.js --help` | 203 | 214 | 0 |
| `apps/cli/lib/bin.js --profile tui --dump-config` (isolated home, first) | 599 | 599 | 0 |
| `apps/cli/lib/bin.js --profile tui --dump-config` (isolated home, warm) | 400 | 405 | 0 |

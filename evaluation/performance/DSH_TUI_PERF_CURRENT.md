...
Recorded UTC: 2026-08-29T08:30:35.563Z
Source: local working tree based on HEAD `94a9046e0b1f`; TUI package `0.1.0-rc.11`.
...
|---|---:|---:|---:|---:|
| 100 | 223 | 400 | 1490322 | 20.0 |
| 500 | 223 | 512 | 1493061 | 15.8 |
...
|---|---:|---:|---|
| Fold heap, 100 turns | 17.5 MB | 20.0 MB | same range; no forced GC in either run |
| Fold heap, 500 turns | 19.0 MB | 15.8 MB | same range; no forced GC in either run |
| `dsh-tui --version` | 90–92 ms | 87 ms median | lower in this sample |
| built `--help` | about 100 ms | 107 ms median | same range |
| warm `--dump-config` | 300–600 ms | 507 ms median | inside the historical range |
...
|---|---:|---:|---:|
| `apps/tui-cli/bin/dsh-tui.js --version` | 87 | 96 | 0 |
| `apps/cli/lib/bin.js --help` | 107 | 110 | 0 |
| `apps/cli/lib/bin.js --profile tui --dump-config` (isolated home, first) | 709 | 709 | 0 |
| `apps/cli/lib/bin.js --profile tui --dump-config` (isolated home, warm) | 507 | 528 | 0 |
